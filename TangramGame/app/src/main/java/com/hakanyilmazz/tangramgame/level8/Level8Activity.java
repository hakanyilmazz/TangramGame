package com.hakanyilmazz.tangramgame.level8;
...
import com.hakanyilmazz.tangramgame.level9.Level9Activity;
import com.hakanyilmazz.tangramgame.level_controllers.TimeController;

import java.util.ArrayList;

public class Level8Activity extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {

    private static final long LEVEL8_TIME = 17500 + TimeController.increaseTime();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoreText = findViewById(R.id.level8ScoreText);
        timeText = findViewById(R.id.level8TimeText);
    ...
    private void setCountDownTimer(long level1Time) {
        countDownTimer = new CountDownTimer(level1Time, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(Level8Activity.this, "Time's Up!", Toast.LENGTH_SHORT).show();
                setTimesUpAlert();
            }
        };
    ...
    private void setTimesUpAlert() {
        ...
        alert.setNegativeButton("No", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(Level8Activity.this, "See You Again!", Toast.LENGTH_SHORT).show();
                setHighScore();
                finish();
            }
        });
    ...
    private void setOriginalImageViews() {
        originalImageViews.add(findViewById(R.id.level8_solUstUcgen2));
        originalImageViews.add(findViewById(R.id.level8_sagUstUcgen2));
        originalImageViews.add(findViewById(R.id.level8_ustUcgen2));
        originalImageViews.add(findViewById(R.id.level8_kare2));
        originalImageViews.add(findViewById(R.id.level8_sariUcgen2));
        originalImageViews.add(findViewById(R.id.level8_yamuk2));
        originalImageViews.add(findViewById(R.id.level8_maviUcgen2));
    }

    private void setMustBeImageViews() {
        mustBeImageViews.add(findViewById(R.id.level8_solUstUcgen));
        mustBeImageViews.add(findViewById(R.id.level8_sagUstUcgen));
        mustBeImageViews.add(findViewById(R.id.level8_ustUcgen));
        mustBeImageViews.add(findViewById(R.id.level8_kare));
        mustBeImageViews.add(findViewById(R.id.level8_sariUcgen));
        mustBeImageViews.add(findViewById(R.id.level8_yamuk));
        mustBeImageViews.add(findViewById(R.id.level8_maviUcgen));
    }
