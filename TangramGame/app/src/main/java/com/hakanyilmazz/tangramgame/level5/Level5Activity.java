package com.hakanyilmazz.tangramgame.level5;
...
import com.hakanyilmazz.tangramgame.level6.Level6Activity;
import com.hakanyilmazz.tangramgame.level_controllers.TimeController;

import java.util.ArrayList;

public class Level5Activity extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {

    private static final long LEVEL5_TIME = 25500 + TimeController.increaseTime();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoreText = findViewById(R.id.level5ScoreText);
        timeText = findViewById(R.id.level5TimeText);
    ...
    private void setCountDownTimer(long level1Time) {
        countDownTimer = new CountDownTimer(level1Time, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(Level5Activity.this, "Time's Up!", Toast.LENGTH_SHORT).show();
                setTimesUpAlert();
            }
        };
    ...
    private void setTimesUpAlert() {
        ...
        alert.setNegativeButton("No", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(Level5Activity.this, "See You Again!", Toast.LENGTH_SHORT).show();
                setHighScore();
                finish();
            }
        });
    ...
    private void setOriginalImageViews() {
        originalImageViews.add(findViewById(R.id.level5_sag_ucgen_sari2));
        originalImageViews.add(findViewById(R.id.level5_sol_ucgen_mavi2));
        originalImageViews.add(findViewById(R.id.level5_kare2));
        originalImageViews.add(findViewById(R.id.level5_ust_ucgen2));
        originalImageViews.add(findViewById(R.id.level5_sol_ust_ucgen2));
        originalImageViews.add(findViewById(R.id.level5_sag_alt_ucgen2));
        originalImageViews.add(findViewById(R.id.level5_yamuk2));
    }

    private void setMustBeImageViews() {
        mustBeImageViews.add(findViewById(R.id.level5_sag_ucgen_sari));
        mustBeImageViews.add(findViewById(R.id.level5_sol_ucgen_mavi));
        mustBeImageViews.add(findViewById(R.id.level5_kare));
        mustBeImageViews.add(findViewById(R.id.level5_ust_ucgen));
        mustBeImageViews.add(findViewById(R.id.level5_sol_ust_ucgen));
        mustBeImageViews.add(findViewById(R.id.level5_sag_alt_ucgen));
        mustBeImageViews.add(findViewById(R.id.level5_yamuk));
    }
    ...
    private void setMustBeImagesTags() {
        mustBeImageViews.get(ShapeIndex.SAG_UCGEN_SARI).setTag("SAG_UCGEN_SARI");
    ...
    private void setOriginalImagesTags() {
        originalImageViews.get(ShapeIndex.SAG_UCGEN_SARI).setTag("SAG_UCGEN_SARI2");
    ...
    private int getShapeIndex(String tag) {
        switch (tag) {
            case "SAG_UCGEN_SARI2":
                return ShapeIndex.SAG_UCGEN_SARI;
