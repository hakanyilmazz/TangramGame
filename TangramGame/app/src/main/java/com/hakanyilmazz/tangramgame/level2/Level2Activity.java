package com.hakanyilmazz.tangramgame.level2;
...
import com.hakanyilmazz.tangramgame.level3.Level3Activity;
import com.hakanyilmazz.tangramgame.level_controllers.TimeController;

import java.util.ArrayList;

public class Level2Activity extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {

    private static final long LEVEL2_TIME = 32500 + TimeController.increaseTime();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoreText = findViewById(R.id.level2ScoreText);
        timeText = findViewById(R.id.level2TimeText);
    ...
    private void setCountDownTimer(long level1Time) {
        countDownTimer = new CountDownTimer(level1Time, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(Level2Activity.this, "Time's Up!", Toast.LENGTH_SHORT).show();
                setTimesUpAlert();
            }
        };
    ...
    private void setTimesUpAlert() {
        ...
        alert.setNegativeButton("No", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(Level2Activity.this, "See You Again!", Toast.LENGTH_SHORT).show();
                setHighScore();
                finish();
            }
        });
    ...
    private void setOriginalImageViews() {
        originalImageViews.add(findViewById(R.id.level2Yamuk2));
        originalImageViews.add(findViewById(R.id.level2UstUcgen2));
        originalImageViews.add(findViewById(R.id.level2SagUstUcgen2));
        originalImageViews.add(findViewById(R.id.level2Kare2));
        originalImageViews.add(findViewById(R.id.level2SolUstUcgen2));
        originalImageViews.add(findViewById(R.id.level2SolAltUcgen2));
        originalImageViews.add(findViewById(R.id.level2UstUcgenAlt2));
    }

    private void setMustBeImageViews() {
        mustBeImageViews.add(findViewById(R.id.level2Yamuk));
        mustBeImageViews.add(findViewById(R.id.level2UstUcgen));
        mustBeImageViews.add(findViewById(R.id.level2SagUstUcgen));
        mustBeImageViews.add(findViewById(R.id.level2Kare));
        mustBeImageViews.add(findViewById(R.id.level2SolUstUcgen));
        mustBeImageViews.add(findViewById(R.id.level2SolAltUcgen));
        mustBeImageViews.add(findViewById(R.id.level2UstUcgenAlt));
    }
    ...
    private void setMustBeImagesTags() {
        ...
        mustBeImageViews.get(ShapeIndex.UST_UCGEN_ALT).setTag("UST_UCGEN_ALT");
    }
    ...
    private void setOriginalImagesTags() {
        ...
        originalImageViews.get(ShapeIndex.UST_UCGEN_ALT).setTag("UST_UCGEN_ALT2");
    }
    ...
    private int getShapeIndex(String tag) {
        switch (tag) {
            ...
            case "UST_UCGEN_ALT2":
                return ShapeIndex.UST_UCGEN_ALT;
            default:
                return 0;
        }
    }
